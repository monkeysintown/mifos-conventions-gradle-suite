...
///
package org.mifos.conventions.gradle.template.model;
...
public class MifosGradleTemplateIndex implements Serializable {
    @Serial
    ...
    public static class TemplateParameter implements Serializable {
        ...
        public Integer getDefaultValueAsInt() {
            ...
            throw new RuntimeException("Default value is not of type integer: %s"
        ...
        public Double getDefaultValueAsDecimal() {
            ...
            throw new RuntimeException("Default value is not of type decimal: %s"
                    .formatted(defaultValue.getClass().getCanonicalName()));
        }
        ...
        public Boolean getDefaultValueAsBool() {
            ...
            throw new RuntimeException("Default value is not of type bool: %s"
                    .formatted(defaultValue.getClass().getCanonicalName()));
        }
    }
