        ...
        project.getTasks()
                .register(MIFOS_TASK_TEMPLATE_INDEX_CREATE, MifosGradleTemplateIndexCreateTask.class, task -> {
                    ...
                    task.getVersion()
                            .set(templateExtension
                                    .getVersion()
                                    .orElse(project.getRootProject()
                                            .getVersion()
                                            .toString()));
                    task.getDependency()
                            .set(templateExtension
                                    .getDependency()
                                    .orElse(project.getRootProject().getGroup() + ":" + project.getName() + ":tgz:tpl:"
                                            + project.getRootProject().getVersion()));
                });
            ...
            publishing.publications(
                    publications -> publications.create("template", MavenPublication.class, publication -> {
                        publication.setGroupId(
                                project.getRootProject().getGroup().toString());
                        publication.setVersion(
